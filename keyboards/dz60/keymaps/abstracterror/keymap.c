...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        _______,          KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          _______,
        _______, XXXXXXX, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_INS,  _______,          XXXXXXX,
        _______, _______, _______,                   SY_BSPC, _______, _______,                   _______, _______, XXXXXXX, _______, _______
    ),
    ...
    [_NM] = LAYOUT(
        ...
        _______,          KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______, KC_EQL,  KC_4,    KC_5,    KC_6,    KC_MINS, _______,          _______,
        _______, XXXXXXX, _______, _______, _______, _______, _______, _______, KC_1,    KC_2,    KC_3,    KC_BSLS, _______,          XXXXXXX,
        _______, _______, _______,                   _______, _______, SY_SPC,                    _______, _______, XXXXXXX, _______, _______
    ),

    [_SY] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX, _______,
        _______,          _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_DQUO, _______, _______, _______, _______,
        _______,          KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______, _______, KC_LBRC, KC_RBRC, KC_QUOT, _______, _______,          _______,
        _______, XXXXXXX, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          XXXXXXX,
