...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DF] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                   NM_BSPC, SY_ENT,  FN_SPC,                    KC_RGUI, KC_RALT, XXXXXXX, MO(_CT), KC_RCTL
    ),
    ...
    [_NM] = LAYOUT(
        ...
        _______, _______, _______,                   _______, _______, KC_0,                      _______, _______, XXXXXXX, _______, _______
    ),
